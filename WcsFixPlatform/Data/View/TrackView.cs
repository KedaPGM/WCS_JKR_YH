...
namespace wcs.Data.View
{
    public class TrackView : ViewModelBase
    {
        ...
        //private short order;
        private TrackAlertE alert_status;
        private uint alert_carrier;
        private bool earlyfull;
        ...
        {
            get => alert_status;
            set => Set(ref alert_status, value);
        }

        public uint AlertCarrier
        {
            get => alert_carrier;
            set => Set(ref alert_carrier, value);
        }

        public bool EarlyFull
        {
            get => earlyfull;
            set => Set(ref earlyfull, value);
        }

        public DateTime? FullTime
        {
            get => fulltime;
            set => Set(ref fulltime, value);
        }
        ...
        public void Update(Track track)
        {
            ...
            Memo = track.memo;
            AlertStatus = track.AlertStatus;
            AlertCarrier = track.alert_carrier;
            EarlyFull = track.early_full;
            FullTime = track.full_time;
            switch (Status)
            {
